...
INSERT INTO book (book_id, title) VALUES (6, 'it''s all about the bike: the pursuit of happiness on two wheels');

SELECT setval(pg_get_serial_sequence('book', 'book_id'), 6);
...
INSERT INTO character (character_id, f_name, l_name) VALUES (6, 'robert', 'penn');

SELECT setval(pg_get_serial_sequence('character', 'character_id'), 6);
...
INSERT INTO book_character (book_id, character_id) VALUES (6, 6);
...
INSERT INTO book_location (book_id, location_id) VALUES (6, 2);
...
INSERT INTO book_keyword (book_id, keyword_id) VALUES (6, 3);
